      ...
      <FlatList
        ...
        ListHeaderComponent={
          <>
            ...
            {loading && <ActivityIndicator size="large" color="	#ff0065" className="my-3" />}
        ...
        ListEmptyComponent={
          !loading && !error ? (
            <View className="mt-10 px-5 ">
              <Text className="text-center text-gray-500">{searchQuery.trim() ? "No movies found" : "Start typing to search for movies"}</Text>
            </View>
          ) : null
        }
      />
